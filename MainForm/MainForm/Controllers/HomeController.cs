...
namespace MainForm.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(IJobManage JobContext, IRoutingManage RoutingContext, IOperationsSubmitManage SubmitContext,
            ILogger<HomeController> logger, ISysCommonManage SysCommonContext, IMapper mapper)
        {
            _logger ??= logger;
            _mapper ??= mapper;
